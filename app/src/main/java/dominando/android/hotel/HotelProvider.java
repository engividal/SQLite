...
public class HotelProvider extends ContentProvider {
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        switch (uriType){
            ...
            case TIPO_HOTEL_ESPECIFICO:
                ...
                linhasAfetadas = sqlDB.update(HotelSQLHelper.TABELA_HOTEL, values, HotelSQLHelper.COLUNA_ID + "= ?", new String[]{ id });
                break;
            default:
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriType){
            ...
            case TIPO_HOTEL_ESPECIFICO:
                String id = uri.getLastPathSegment();
                rowsDeleted = sqlDB.delete(HotelSQLHelper.TABELA_HOTEL, HotelSQLHelper.COLUNA_ID + "= ?", new String[]{ id });
                break;
            default:
