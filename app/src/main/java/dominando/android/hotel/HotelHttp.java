...
/**
 * Created by Ismael on 09/01/16.
 */
public class HotelHttp {
    public static final String SERVIDOR = "http://192.168.1.109/hotel_service";
    private static final String WEBSERVICE_URL = SERVIDOR + "/webservice.php";
    private Context mContext;
    private HotelRepositorio mRepositorio;

    public HotelHttp(Context mContext) {
        this.mContext = mContext;
        this.mRepositorio = new HotelRepositorio(mContext);
    }
    ...
    private HttpURLConnection abrirConexao(String url, String metodoHttp, boolean doOutput) throws Exception {
